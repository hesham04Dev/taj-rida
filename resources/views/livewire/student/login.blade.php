<div class="min-h-screen flex items-center justify-center">
    <div class="w-full max-w-sm">
        ...
        <div class="text-center mb-8">
            ...
            <h1 class="text-2xl font-bold text-white">تاج الرضا</h1>
            <p class="text-zinc-400 text-sm mt-1">بوابة الطالب</p>
        </div>

        {{-- Card --}}
        <div class="bg-zinc-900 border border-zinc-800 rounded-2xl p-8 shadow-2xl">
            <h2 class="text-lg font-semibold text-white mb-6 text-center">تسجيل الدخول</h2>

            <form wire:submit="submit" class="space-y-5">
                <flux:field>
                    <flux:label class="text-zinc-300">رمز الدخول</flux:label>
                    <flux:input
                        id="access_code"
